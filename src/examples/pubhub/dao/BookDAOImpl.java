...
/** ================================================================================================
 * This class is part of the base package of the application. It was written by Revature. No changes have been made to this class (or the supporting inerface), but many of these methods and statements have been utilized in the creation of the Tag DAO. Implementation for the BookDAO, responsible for querying the database for Book objects.
 * ================================================================================================
 */
public class BookDAOImpl implements BookDAO {
	...
	public List<Book> getAllBooks() {
		...
		try {
			...
			while (rs.next()) {
				...
				// The SQL DATE datatype maps to java.sql.Date... which isn't well supported anymore. We use a LocalDate instead, because this is Java 8.
				book.setPublishDate(rs.getDate("publish_date").toLocalDate());
				book.setPrice(rs.getDouble("price"));
				
				// The PDF file is tricky; file data is stored in the DB as a BLOB - Binary Large Object. It's literally stored as 1's and 0's, so this one data type can hold any type of file.
			...
			// We need to make sure our statements and connections are closed, or else we could wind up with a memory leak
			closeResources();
		}
	...
	public boolean addBook(Book book) {
		...
		try {
			...
			// If we were able to add our book to the DB, we want to return true. This if statement both executes our query, and looks at the return value to determine how many rows were changed
