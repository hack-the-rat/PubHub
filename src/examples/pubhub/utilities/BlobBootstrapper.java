...
/*
 * This class is used to bootstrap the application. The included script will insert the first row, but the book file  will be empty. Running this class will update that empty file to a stock PDF, so all features of the site can be reliably used without having to publish new books.
 * 
