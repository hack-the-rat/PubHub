...
/* ================================================================================================
 * Servlet implementation class for publishing a book.
 * ================================================================================================
 */

@MultipartConfig // This annotation tells the server that this servlet has complex data other than forms. Notice the lack of the @WebServlet annotation? This servlet is mapped the old fashioned way - Check the web.xml!
public class PublishBookServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		TagDAO db = DAOUtilities.getTagDAO();
		...
		if (tempBook != null) {
			...
			Tag tag = new Tag();
			tag.setName(req.getParameter("tags"));
