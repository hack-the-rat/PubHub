...
public class DownloadBookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// In order to download the PDF to the client, we need to add a data stream to the response. First we set the content type to PDF, so the browser knows how to interpret the data it's receiving
