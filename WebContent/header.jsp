    	...
    	<nav class="navbar navbar-default navbar-fixed-top">
            ...
            <!-- Collect the nav links, forms, and other content for toggling -->
            	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                	...
                	<!--  This dropdown is for authors/publishers -->
						<li class="dropdown">
                        	<a href="#" class="dropdown-toggle" data-toggle="dropdown">Book Publishing<b class="caret"></b></a>
                        	<ul class="dropdown-menu">
                          		<li>
                          			<a href="BookPublishing">Home (Level 100)</a>
                          		</li>
                          		<li class="divider"></li>
                          		<li>
                          			<a href="TagSearchHome"> Browse books by tag</a>
                          		</li>
                          		<li>
